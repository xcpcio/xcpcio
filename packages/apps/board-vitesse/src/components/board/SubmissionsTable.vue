...
<template>
  <section>
    <div class="mx-auto px-4 max-w-screen-2xl lg:min-w-screen-2xl lg:px-12">
      <div class="overflow-hidden bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg">
        <div class="flex flex-col px-4 lg:space-y-0 py-3 lg:flex-row lg:items-center lg:justify-between space-y-3 lg:space-x-4">
          <div class="flex flex-col space-y-3 flex-shrink-0 md:flex-row md:items-center lg:justify-end md:space-x-3 md:space-y-0">
            <button v-if="notShowing" type="button" class="flex items-center justify-center rounded-lg px-4 text-sm bg-primary-700 py-2 font-medium text-white dark:bg-primary-600 hover:bg-primary-800 focus:outline-none focus:ring-4 focus:ring-primary-300 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
            ...
            <button v-if="notShowing" type="button" class="flex flex-shrink-0 items-center justify-center border rounded-lg bg-white py-2 text-sm font-medium text-gray-900 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-400 focus:outline-none focus:ring-4 border-gray-200 px-3 focus:z-10 hover:bg-gray-100 hover:text-primary-700 focus:ring-gray-200 dark:hover:bg-gray-700 dark:hover:text-white dark:focus:ring-gray-700">
        ...
        <div class="overflow-x-auto">
          <table class="w-full text-sm text-gray-500 dark:text-gray-400 text-left">
            <thead class="dark:text-gray-400 bg-gray-50 text-xs uppercase text-gray-700 dark:bg-gray-700">
              <tr>
              ...
              <template v-for="s in currentSubmissions" :key="s.id">
                <tr class="dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700 border-b">
                  <td class="px-4 py-2 font-mono">
                    <span class="text-xs font-medium rounded bg-primary-100 px-2 py-0.5 text-primary-800 dark:bg-primary-900 dark:text-primary-300">
                  ...
                  <td v-if="notShowing" class="whitespace-nowrap px-4 py-2 font-medium text-gray-900 dark:text-white">
                    <div class="flex items-center">
                      <div class="mr-2 h-4 w-4 rounded-full inline-block bg-red-700" />
                      95
                    </div>
                  </td>
