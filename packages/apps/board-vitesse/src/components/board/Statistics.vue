...
<template>
  ...
  >
    <section>
      <div class="px-4 mx-auto max-w-screen-xl lg:px-6 py-4 lg:py-6">
        <div class="space-y-8 lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-10 lg:space-y-0">
          <div v-for="h in getHeadData()" :key="h.title">
            <div class="flex flex-col p-6 mx-auto text-center text-gray-900 bg-white rounded-lg border border-gray-100 shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white max-w-[16rem]">
