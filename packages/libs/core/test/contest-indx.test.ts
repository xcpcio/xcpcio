...
describe("contest-index", () => {
  it("common", () => {
    ...
    expect(contestIndexList[0]).toMatchInlineSnapshot(`
      ContestIndex {
        "boardLink": "/provincial-contest/2023/guangxi",
        "contest": Contest {
          "badge": undefined,
          "banner": undefined,
          "boardLink": undefined,
      ...
      ",
          ...
          "medal": undefined,
          "name": I18nText {
            "fallback": "2023 年第六届广西大学生程序设计竞赛（正式赛）",
            "texts": Map {},
          },
          "options": ContestOptions {
            "calculationOfPenalty": "in_minutes",
            "reactionVideoUrlTemplate": undefined,
    ...
    expect(contestIndexList.slice(-1)[0]).toMatchInlineSnapshot(`
      ContestIndex {
        "boardLink": "/icpc/2009/nit_online",
        "contest": Contest {
          "badge": undefined,
          "banner": undefined,
          "boardLink": undefined,
