...
describe("contest", () => {
  it("2023_ccpc_final", () => {
    ...
    `);
    expect(firstTeam.placeChartPoints.map(p => [p.timePoint, p.rank])).toMatchInlineSnapshot(`
      [
        [
          0,
          1,
    ...
    `);
    expect(lastTeam.placeChartPoints.map(p => [p.timePoint, p.rank])).toMatchInlineSnapshot(`
      [
        [
          0,
          1,
