...
response = requests.get('https://pintia.cn/api/problem-sets/1322401187006472192/rankings', headers=headers, params=params, cookies=cookies)

#NB. Original query string below. It seems impossible to parse and
#reproduce query strings 100% accurately so the one below is given
#in case the reproduced version is not "correct".
# response = requests.get('https://pintia.cn/api/problem-sets/1322401187006472192/rankings?limit=50', headers=headers, cookies=cookies)
...
def fetch():
    ...
    for i in range(((total + 49) // 50)):
        ...
        req_list.append(grequests.get('https://pintia.cn/api/problem-sets/1322401187006472192/rankings', headers=headers, params=params, cookies=cookies))
