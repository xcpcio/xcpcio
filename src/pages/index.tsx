        ...
        {this.state.loaded && (
          <>
            ...
            <table className="standings">
              <tbody>
                <tr>
                  <th className="stnd" style={{ width: '4em' }}>
                    Place
                  </th>
                  <th className="stnd" style={{ width: '15%' }}>
                    School
                  </th>
                  <th className="stnd" style={{ width: '35%' }}>
                    Team
                  </th>
                  <th className="stnd" style={{ width: '4em' }}>
                    Solved
                  ...
                  {this.state.problem_info.map((item: any) => {
                    return (
                      <th className="success" style={{ width: '4em' }}>
                        {item.problem_id}
                        <br />
                        <s>
                ...
                {this.state.team_list.map((item: any) => {
                  return (
                    <tr className={['stand', item.stand_className_id].join('')}>
                      <td className={item.place_className}>{item.place}</td>
                      <td className="stnd">{item.school}</td>
                      ...
                      {item.detail.map((item: any) => {
                        ...
                        if (
                          ...
                          ch_status = '+';
                        if (item.status === 'incorrect') ch_status = '-';
                        if (item.status === 'pending') ch_status = '?';
                        if (item.status === 'unattempted') ch_status = '.';
                        return (
